...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '03_27_H_E_R_M_I_T_ZFBUGGF',
    MODE: (process.env.MODE || 'private').toLowerCase(),
    HANDLERS: (process.env.PREFIX || '^[.,!]').trim(),
    SEND_READ: (process.env.READ_COMMAND || false),
    READ_MSG: process.env.READ_MSG === 'false', 
    MSG_LOG: convertToBool(process.env.LOG_MSG) || true, 
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
    ALWAYS_ONLINE: toBool(process.env.ALWAYS_ONLINE),
    BOT_NAME: process.env.BOT_NAME || 'SNARCO',
    ...
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'SnARrCo;elMo3AlEem' : process.env.STICKER_DATA,
    ...
    KOYEB_APP_NAME: process.env.KOYEB_APP_NAME || 'wawawamm',
